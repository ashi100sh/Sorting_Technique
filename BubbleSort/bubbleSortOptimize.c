 ...
 * Optimization: If array is already sorted then don't check comparing pairs of adjacent elements.
 * In that case simply break from loop.
 */
#include <stdio.h>
#include <stdbool.h>
...
void bubbleSort(int arr[], int size)
{
    ...
    for(int i=0; i<size-1; i++)
    {
        ...
        //If inner loop haven't perform any sorting , it means it is sorted array.
        if(sorted == true)
            break;
    }
    printf("No of swap: %d\n", no_of_swap);
